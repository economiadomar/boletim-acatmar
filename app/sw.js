...
var CACHE='forum-acatmar-v10';
var SHELL=['./','index.html','app.css?v=10','app.js?v=10','lib/qrcode.min.js','lib/jspdf.umd.min.js','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png','media/hero.jpg','media/emblema-v2.jpg','../media/logos/acatmar-branca.png','media/logos/prefeitura-florianopolis.png','media/logos/acatmar.png','media/logos/mundo-mar.png','media/logos/safeboat.png','media/logos/personal-boat.png','media/logos/ifsc.png','media/logos/marina-escola.png','media/logos/okean.svg','media/logos/veleiros-da-ilha.png'];
