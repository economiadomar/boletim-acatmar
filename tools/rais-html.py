...
put('nota', f'<b>Cadeia náutica e naval na RAIS.</b> A ACATMAR lê os microdados públicos da RAIS por estabelecimento e agrupa {len(R["definicao"])} subclasses CNAE em cinco grupos: indústria náutica, comércio e serviços náuticos, indústria naval, portos e navegação, pesca e aquicultura ({defs}). Conta estabelecimentos com pelo menos um vínculo ativo em 31 de dezembro; empresas sem empregado (MEI e autônomos) não aparecem, o que explica a diferença para as contagens da Receita Federal e do Sebrae. O Pernambuco aparece com poucos estabelecimentos e muitos vínculos na construção de esporte e lazer, o que indica um grande estaleiro classificado nessa subclasse. ')
